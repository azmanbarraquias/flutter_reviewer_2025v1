...
void main() {
  runApp(
    const MaterialApp(
      home: Scaffold(body: Center(child: CustomCupertinoPickerApp())),
    ),
  );
}
        ...
        body: Center(
          child: Container(
            ...
            child: CustomCupertinoDatePicker(
              ...
              selectedStyle: const TextStyle(color: Colors.black, fontSize: 16),
...
class _CustomCupertinoDatePickerState extends State<CustomCupertinoDatePicker> {
  ...
  Widget _daySelector() {
    return _selector(
      ...
      onSelectedItemChanged:
          (v) => _onSelectedItemChanged(v, _SelectorType.day),
    );
  }
  ...
  Widget _monthSelector() {
    return _selector(
      ...
      onSelectedItemChanged:
          (v) => _onSelectedItemChanged(v, _SelectorType.month),
    );
  }
  ...
  Widget _yearSelector() {
    return _selector(
      ...
      onSelectedItemChanged:
          (v) => _onSelectedItemChanged(v, _SelectorType.year),
    );
  }
