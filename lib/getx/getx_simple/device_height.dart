              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    // final mediaQueryViewPadding = MediaQuery.of(context).viewPadding;
                    TextItem(
                      text: 'Device Height: ${mediaQuerySize.height.fix(2)}',
                    ),
                    TextItem(
                      text: 'Device Width: ${mediaQuerySize.width.fix(2)}',
                    ),
                    TextItem(
                      text:
                          'Device viewPadding Top: ${mediaQueryViewPadding.top.fix(2)}',
                    ),
                    TextItem(
                      text:
                          'Device viewPadding Bottom: ${mediaQueryViewPadding.bottom.fix(2)}',
                    ),
                  ],
                ),
                const Divider(),
                Column(
                  ...
                  children: [
                    ...
                    TextItem(
                      text:
                          'Get statusBarHeight: ${(Get.statusBarHeight / contextMediaQuery.devicePixelRatio).fix(2)}',
                    ),
                    TextItem(
                      text:
                          'Get bottomBarHeight: ${Get.bottomBarHeight.fix(2)}',
                    ),
                  ],
                ),
              ],
